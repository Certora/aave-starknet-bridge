...
contract BridgeHarness is Bridge {
     ...
     *        Getters        *
     *************************/
    function getL2Bridge() public view returns (uint256 l2Bridge) {
        return _l2Bridge;
    }
    ...
    function getIncentivesController()
        public
        view
        returns (IAaveIncentivesController incentivesController)
    {
        return _incentivesController;
    }

    function getRewardToken() public view returns (IERC20 rewardToken) {
        return _rewardToken;
    }

    function getL2AddressOfAToken(address AToken)
        public
        view
        returns (uint256 l2TokenAddress)
    {
        return _aTokenData[AToken].l2TokenAddress;
    }

    function getApprovedL1TokensLength() public view returns (uint256 length) {
    ...
    // A wrapper function for _approveBridgeTokens
    function _approveBridgeTokens_Wrapper(
        address[] calldata l1Tokens,
        uint256[] calldata l2Tokens
    ) external {
        return super._approveBridgeTokens(l1Tokens, l2Tokens);
    }
